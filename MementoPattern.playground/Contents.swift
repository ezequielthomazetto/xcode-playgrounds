...
class Originator {
    ...
    func appendText(text: String) {
        print("Originator: I'm append a text.")
        state += text
        print("Originator: and my state has changed to: \(state)")
    }
...
class Test {
    ...
    static func testSimple () {
        let originator = Originator(state: "Memento")
    ...
    static func testEditor () {
        let originator = Originator(state: "Win e-commerce")
        let caretaker = Caretaker(originator: originator)
        
        caretaker.backup()
        originator.appendText(text: " & Become the Fintech liader")
        ...
        caretaker.backup()
        originator.appendText(text: " & Become the Fintech leader.")
    }
}
